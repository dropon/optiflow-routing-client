...
* `DE_STUTTGART_KLEINE_UMWELTZONE` (value: `"DE_STUTTGART_KLEINE_UMWELTZONE"`)

* `DE_STUTTGART_UMWELTZONE` (value: `"DE_STUTTGART_UMWELTZONE"`)
...
* `ES_ZBE_MADRID` (value: `"ES_ZBE_MADRID"`)
...
* `FR_PARIS_ZFE` (value: `"FR_PARIS_ZFE"`)

* `FR_STRASBOURG_ZFE` (value: `"FR_STRASBOURG_ZFE"`)

* `FR_TOULOUSE_ZFE` (value: `"FR_TOULOUSE_ZFE"`)
