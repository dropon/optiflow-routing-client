...
type RouteOptions struct {
	...
	Penalties *PenaltyOptions `json:"penalties,omitempty"`
...
// GetPenalties returns the Penalties field value if set, zero value otherwise.
func (o *RouteOptions) GetPenalties() PenaltyOptions {
	if o == nil || IsNil(o.Penalties) {
		var ret PenaltyOptions
		return ret
	}
	return *o.Penalties
}
...
// SetPenalties gets a reference to the given PenaltyOptions and assigns it to the Penalties field.
func (o *RouteOptions) SetPenalties(v PenaltyOptions) {
	o.Penalties = &v
}

// GetAllowDeliveryOnlyGates returns the AllowDeliveryOnlyGates field value if set, zero value otherwise.
func (o *RouteOptions) GetAllowDeliveryOnlyGates() bool {
	if o == nil || IsNil(o.AllowDeliveryOnlyGates) {
		var ret bool
		return ret
	}
	return *o.AllowDeliveryOnlyGates
}

// GetAllowDeliveryOnlyGatesOk returns a tuple with the AllowDeliveryOnlyGates field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RouteOptions) GetAllowDeliveryOnlyGatesOk() (*bool, bool) {
	if o == nil || IsNil(o.AllowDeliveryOnlyGates) {
		return nil, false
	}
	return o.AllowDeliveryOnlyGates, true
}
...
// SetAllowDeliveryOnlyGates gets a reference to the given bool and assigns it to the AllowDeliveryOnlyGates field.
func (o *RouteOptions) SetAllowDeliveryOnlyGates(v bool) {
	o.AllowDeliveryOnlyGates = &v
}
...
func (o RouteOptions) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Penalties) {
		toSerialize["penalties"] = o.Penalties
	}
	if !IsNil(o.AllowDeliveryOnlyGates) {
		toSerialize["allowDeliveryOnlyGates"] = o.AllowDeliveryOnlyGates
	}
